...
declare module BABYLON.GUI {
    ...
    export class TextBlock extends Control {
        ...
        public _textHorizontalAlignment: number;
        ...
        public _underline: boolean;
	    public _lineThrough: boolean;
        /**
        ...
        protected _getTypeName(): string;
        protected _processMeasures(parentMeasure: Measure, context: CanvasRenderingContext2D): void;
	    protected _drawText(text: string, textWidth: number, y: number, context: ICanvasRenderingContext): void;
        /** @hidden */
        _draw(context: CanvasRenderingContext2D, invalidatedRectangle?: BABYLON.Nullable<Measure>): void;
        protected _applyStates(context: CanvasRenderingContext2D): void;
